...
// Note: Standard fonts don't support Bengali Taka symbol (৳). We'll use Tk to ensure no missing glyphs.
...
export const PurchaseInvoicePDF = ({ purchase }: { purchase: IPurchase }) => (
  <Document>
    <Page size="A4" style={styles.page}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.textRow}>
            <Text style={styles.label}>Purchase No: </Text>
            <Text style={styles.value}>{purchase.purchaseNo}</Text>
          </Text>
          <Text style={styles.textRow}>
      ...
      <View style={styles.section}>
        <View style={styles.box}>
          ...
          <Text style={{ fontSize: 9, color: "#64748b" }}>
            {purchase.supplier?.company || "Unknown Company"}
          </Text>
        </View>
        <View style={styles.box}>
          ...
          >
            ...
            >
              {formatStatusText(purchase.paymentMethod)}
            </Text>
          </View>
          <View
        ...
        {purchase.items.map((item, index) => (
          <View key={index} style={styles.tableRow}>
            ...
            <Text style={[styles.col3, { fontSize: 10, color: "#334155" }]}>
              Tk {item.unitCost.toLocaleString()}
            </Text>
            <Text
              style={[
                styles.col4,
      ...
      <View style={styles.summary}>
        <View style={styles.summaryRow}>
          ...
          <Text style={styles.summaryValue}>
            Tk {purchase.subTotal.toLocaleString()}
          </Text>
        </View>
        {purchase.discount > 0 && (
          <View style={styles.summaryRow}>
            ...
            >
              - Tk {purchase.discount.toLocaleString()}
            </Text>
          </View>
        )}
        {purchase.tax > 0 && (
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryValue}>
              + Tk {purchase.tax.toLocaleString()}
            </Text>
          </View>
        )}
      ...
      <View style={styles.footer}>
        <View style={{ marginBottom: 20 }}>
          ...
          <Text style={styles.noteText}>{purchase.note || "N/A"}</Text>
        </View>
        ...
        <View style={styles.signatures}>
          ...
          <View style={styles.signatureLine}>
            <Text style={styles.signatureText}>Supplier Signature</Text>
          </View>
        </View>
      </View>
    </Page>
